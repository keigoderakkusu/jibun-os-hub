...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-dark-300 p-1 text-slate-500 border border-slate-800",
      className
    )}
    {...props}
  />
